...
describe('LP Integration Tests', () => {
  ...
  test('multiple LPs tracked in pool stats', async () => {
    ...
    // Mock getBalance always returns $1000, so share price adjusts as more LPs join
    // LP1: 1000 shares @ $1.00, LP2: 500 shares @ $1.00, LP3: 375 shares @ $0.667
    expect(statsBody.totalShares).toBe(1875);
    expect(statsBody.sharePrice).toBeCloseTo(1000 / 1875, 4);
  });
